...
export const mediaLogos: MediaLogo[] = [
  ...
  { name: "Bloomberg", image: bloombergLogo },
  ...
  { name: "HGTV", image: hgtvLogo },
  { name: "CP24", image: cp24Logo },
  { name: "National Post", image: nationalPostLogo },
  { name: "Storeys", image: storeysLogo },
];
