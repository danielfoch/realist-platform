...
export const EVENT_PARTNERS: EventPartner[] = [
  ...
  },
  {
    ...
    name: "Elevate Realty",
    shortName: "Elevate",
    logo: "/partners/elevate.png",
    website: "https://www.elevatepartners.ca/",
    category: "Real Estate Investment Brokerage",
    tagline: "Multiplex investing experts helping Toronto investors build smarter rental portfolios.",
    description: [
      "Elevate Realty is a Toronto real estate investment brokerage built by investors for investors. The team helps clients identify cash-flowing properties and multiplex opportunities, with advice grounded in the realities of owning and operating rental real estate in the city.",
      "Elevate supports investors across the full ownership journey — from setting an investment strategy and acquiring a property through renovations, leasing, and long-term property management. That integrated approach helps buyers evaluate more than the purchase price by accounting for a property's renovation potential, rental performance, and ongoing operations.",
      "As a sponsor of Unpacking Multiplexes Toronto, Elevate brings an acquisition and investor-focused perspective to the event's practical conversations about finding, improving, and operating missing middle housing in Toronto.",
    ],
    whyPartner: "Successful multiplex investing starts with the right property and a realistic operating plan. Elevate's end-to-end experience helps investors connect acquisition decisions with renovation, leasing, and long-term portfolio performance.",
    event: "Unpacking Multiplexes Toronto",
    eventPath: "/community/events/unpacking-multiplexes-toronto",
    keywords: ["Elevate Realty Toronto", "Toronto multiplex investing", "Toronto investment property", "Toronto real estate investors", "multiplex property management", "Elevate Partners Toronto"],
    relatedTopics: ["Multiplex Investing", "Property Acquisition", "Rental Portfolios", "Toronto Real Estate"],
  },
  {
    slug: "propcare",
    name: "PropCare",
    shortName: "PropCare",
    logo: "/partners/propcare.png",
    website: "https://www.propcare.ca/",
    category: "Property Management Technology",
    tagline: "AI-powered property management for Canadian landlords, property managers, and builders.",
    description: [
      "PropCare is a Canadian property management technology platform designed for landlords, property management firms, and builders. Its AI property manager, Sara, handles day-to-day tenant communication and keeps operational work organized in one workspace.",
      "The platform supports maintenance triage and contractor dispatch, leasing workflows, rent collection and renewals, bookkeeping, and portfolio reporting. Tenants can reach Sara by text or voice at any hour, while owners and managers retain approval controls and a documented audit trail.",
      "As a sponsor of Unpacking Multiplexes Toronto, PropCare brings the operational side of multiplex ownership into focus — helping investors think beyond development and plan for responsive, scalable management once the units are occupied.",
    ],
    whyPartner: "A multiplex only performs when its day-to-day operations work. PropCare's focus on tenant communication, maintenance, leasing, and rent administration gives owners a practical path to managing more units without adding the same amount of administrative work.",
    event: "Unpacking Multiplexes Toronto",
    eventPath: "/community/events/unpacking-multiplexes-toronto",
    keywords: ["PropCare Canada", "AI property management", "Canadian landlord software", "property management automation", "multiplex property management", "PropCare Sara"],
    relatedTopics: ["Property Management", "PropTech", "Rental Operations", "Landlord Automation"],
  },
  {
    slug: "valery",
    name: "Valery",
