...
export async function exportToPDF(data: ExportData): Promise<void> {
  const { address, inputs, results, strategy } = data;
  ...
  y += 4;
  pdf.text("Generated by Realist.ca - Real Estate Investment Analysis Platform", margin, y);
