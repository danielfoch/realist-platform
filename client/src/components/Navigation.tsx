...
import { Menu, X, User, LogOut, Briefcase, Building, ChevronDown, Calculator, MapPin, Users, Handshake, Calendar, Radio, BookOpen, FileText, Info, Mail, ShoppingBag, GraduationCap, DollarSign, TrendingUp, Crown, BarChart3, Shield } from "lucide-react";
...
const navCategories: NavCategory[] = [
  {
    ...
    items: [
      ...
      { href: "/tools/land-claim-screener", label: "Land Claim Screener", description: "Treaty area screening", icon: <Shield className="h-4 w-4" /> },
