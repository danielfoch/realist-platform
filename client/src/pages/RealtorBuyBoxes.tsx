...
const statusColors: Record<string, string> = {
  ...
  contacted: "bg-yellow-500/10 text-yellow-600 dark:text-yellow-400 border-yellow-500/30",
  showing_searching: "bg-purple-500/10 text-purple-600 dark:text-purple-400 border-purple-500/30",
  offer_submitted: "bg-orange-500/10 text-orange-600 dark:text-orange-400 border-orange-500/30",
  under_contract: "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border-indigo-500/30",
  closed: "bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/30",
  not_proceeding: "bg-gray-500/10 text-gray-600 dark:text-gray-400 border-gray-500/30",
};
