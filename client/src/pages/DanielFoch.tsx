...
import { ExternalLink, Mic, BookOpen, TrendingUp, Home } from "lucide-react";
import { Link } from "wouter";

export default function DanielFoch() {
  const links = [
  ...
  return (
    <>
      <SEO
        title="Daniel Foch — Realist.ca"
        description="Daniel Foch is a real estate broker, economist, and investor educator. Co-host of The Canadian Real Estate Investor Podcast."
      />
            ...
            <div className="p-8 sm:p-10">
              <div className="flex items-start gap-5 mb-6">
                ...
                <div>
                  ...
                  <h1 className="text-2xl sm:text-3xl font-bold text-foreground leading-tight mb-1">Daniel Foch</h1>
                  <p className="text-sm text-muted-foreground">Real estate broker · Economist · Investor educator</p>
                </div>
              </div>

              <p className="text-sm text-foreground leading-relaxed mb-3">
                Daniel Foch is a Canadian real estate broker, economist, and investor educator. He co-hosts <span className="font-medium">The Canadian Real Estate Investor Podcast</span> and is a co-founder of Realist.ca — Canada's institutional-grade deal analysis platform for real estate investors.
              </p>
              <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                Daniel helps investors move from theory to execution: understanding markets, running the numbers, building a power team, and structuring deals to hold, scale, or exit.
              </p>

              {/* Expertise tags */}
              <div className="flex flex-wrap gap-2 mb-8">
                {["Multiplex investing", "Deal underwriting", "Canadian market analysis", "Investor education", "Real estate brokerage"].map(tag => (
