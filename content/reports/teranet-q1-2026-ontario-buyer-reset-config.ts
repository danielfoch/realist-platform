...
export const teranetQ12026OntarioBuyerResetConfigReport: ReportContent = {
  ...
  metaTitle: "Ontario First-Time Buyer Age Hits 40: Teranet Q1 2026",
  metaDescription:
  ...
  sections: [
    ...
    },
    {
      ...
      format: "number",
      series: [{ key: "avgAge", label: "Average first-time buyer age", color: "var(--color-brand)" }],
      data: [
        { year: "2015", avgAge: 36 },
        { year: "2020", avgAge: 38 },
        { year: "2025", avgAge: 40 },
    ...
    },
    {
      ...
      format: "percent",
      series: [
        { key: "fthb", label: "First-time homebuyer", color: "var(--color-brand)" },
        { key: "mpo", label: "Multi-property owner", color: "var(--color-signal)" },
        { key: "mover", label: "Mover", color: "var(--color-ink-faint)" },
        { key: "lifeEvent", label: "Life event", color: "var(--color-brand-deep)" },
        { key: "other", label: "Other", color: "var(--color-good)" },
      ],
      data: [
    ...
    },
    {
      ...
      format: "number",
      series: [{ key: "transfers", label: "Power of sale transfers", color: "var(--color-signal)" }],
      data: [
    ...
    },
    {
      ...
      series: [{ key: "lossRate", label: "Sold in 2025 at a loss", color: "var(--color-brand)" }],
      data: [
    ...
    },
    {
      ...
      yAxisLabel: "% sold at a loss",
      format: "percent",
      series: [{ key: "lossRate", label: "2022 purchase, 2025 sale", color: "var(--color-signal)" }],
      data: [
    ...
    },
    {
      ...
      format: "percent",
      series: [{ key: "share", label: "Share of MPOs", color: "var(--color-ink-faint)" }],
      data: [
