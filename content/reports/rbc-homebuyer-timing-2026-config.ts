...
export const rbcHomebuyerTiming2026ConfigReport: ReportContent = {
  ...
  metaTitle: "RBC 2026 Home Ownership Poll: Canadians Say There Is No Perfect Time to Buy",
  metaDescription:
  ...
  sections: [
    ...
    },
    {
      ...
      format: "percent",
      series: [
        { key: "activeBuyers", label: "Intend to purchase within 2 years", color: "var(--color-brand)" },
        { key: "canada", label: "Canada", color: "var(--color-ink-faint)" },
      ],
      data: [
    ...
    },
    {
      ...
      yAxisLabel: "% agree",
      format: "percent",
      series: [{ key: "share", label: "Agree", color: "var(--color-brand)" }],
      data: [
    ...
    },
    {
      ...
      format: "percent",
      series: [
        { key: "buyersMarket", label: "Buyer's market", color: "var(--color-brand)" },
        { key: "sellersMarket", label: "Seller's market", color: "var(--color-signal)" },
      ],
      data: [
    ...
    },
    {
      ...
      series: [
        { key: "activeBuyers", label: "Intend to purchase within 2 years", color: "var(--color-brand)" },
        { key: "canada", label: "Canada", color: "var(--color-ink-faint)" },
        { key: "ontario", label: "Ontario", color: "var(--color-signal)" },
      ],
      data: [
