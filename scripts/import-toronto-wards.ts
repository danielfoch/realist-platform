/**
 * Toronto ward-boundary importer.
 *
 * Loads the City of Toronto 25-ward model (open.toronto.ca, CKAN) into the
 * municipal_wards table so the multiplex underwriter's sixplex-by-ward logic
 * under By-law 654-2025 (lib/multiplex/geo/wards.ts) can resolve a point to a
 * VERIFIED ward instead of the FSA-inferred heuristic.
 *
...
import { ensureTorontoGeoTables } from "../lib/multiplex/geo/torontoGeo";
