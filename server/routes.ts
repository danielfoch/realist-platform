...
import { registerMeetupCalendarRoutes } from "./meetupCalendar";
import { registerMeetupRsvpRoutes } from "./meetupRsvp";
import { registerMeetupOAuthRoutes } from "./meetupOAuth";
...
export async function registerRoutes(
  ...
  registerMeetupCalendarRoutes(app);
  registerMeetupRsvpRoutes(app);
  registerMeetupOAuthRoutes(app);
