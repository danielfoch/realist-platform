import guidesJson from "@/content/encyclopedia/guides.json";
import manifestJson from "@/content/encyclopedia/manifest.json";
import toolSpecsJson from "@/content/encyclopedia/tool-specs.json";
...
/**
 * The old app served guides at /encyclopedia/:slug via `canonicalPath`; the
 * lean IA keeps the same path shape, so stored canonical paths keep working.
 */
...
export const encyclopediaManifest = manifestJson as unknown as EncyclopediaManifest;
