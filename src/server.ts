...
import dealDeskRouter from './deal-desk-routes';
import { createUnderwritingShareRouter } from './underwriting-share-routes';
...
app.use('/api/deal-desk', dealDeskRouter);
app.use('/api', createUnderwritingShareRouter());
